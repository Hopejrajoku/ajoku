    ...
    <header className="fixed top-0 left-0 right-0 z-10 bg-[#D3F1FF] shadow-md">
      ...
      {menuOpen && (
        <div className="md:hidden px-4 pb-4 flex flex-col items-center text-center space-y-4 bg-[#D3F1FF]">
          <Link href="/" className="block w-full text-gray-800 hover:text-blue-500">Home</Link>
          <Link href="/services" className="block w-full text-gray-800 hover:text-blue-500">Services</Link>
          <Link href="/about" className="block w-full text-gray-800 hover:text-blue-500">About Us</Link>
          <Link href="/testimonials" className="block w-full text-gray-800 hover:text-blue-500">Testimonials</Link>
          <Button className="w-full text-gray-800 bg-white hover:text-blue-500">Login</Button>
        </div>
      )}
    </header>
  )
